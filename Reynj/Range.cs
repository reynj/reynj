...
namespace Reynj
{
    ...
    /// <summary>
        ...
        /// </summary>
        /// <param name="step">Value to </param>
        ...
        /// <returns>An <see cref="T:System.Collections.Generic.IEnumerable`1"></see> containing all values between start and end that can be generated by the stepper function</returns>
        // IDEA: Make these protected or internal? Create extension methods on Range<int>, Range<DateTime>, ... that hide the step value and stepper function.
        public IEnumerable<T> EnumerateBy(T step, Func<T, T, T> stepper)
        {
        ...
        /// <returns>An <see cref="T:System.Collections.Generic.IEnumerable`1"></see> containing all values between start and end that can be generated by the stepper function</returns>
        // IDEA: Make these protected or internal? Create extension methods on Range<int>, Range<DateTime>, ... that hide the step value and stepper function.
        public IEnumerable<T> EnumerateBy<TStep>(TStep step, Func<T, TStep, T> stepper)
        {
            if (step == null)
